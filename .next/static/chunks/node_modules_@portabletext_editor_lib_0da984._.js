(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_@portabletext_editor_lib_0da984._.js", {
    ...
    $[16] !== editor || $[17] !== element ? (t9 = (event_0)=>{
        ...
        if (targetBlock) {
            ...
            if (dragPosition === "bottom" && !isBefore) {
                ...
                targetPath = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Path"].next(targetPath), debug$i(`Adjusting targetPath from ${JSON.stringify(originalPath)} to ${JSON.stringify(targetPath)}`);
            }
            if (dragPosition === "top" && isBefore && targetPath[0] !== editor.children.length - 1) {
                const originalPath_0 = targetPath;
                targetPath = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Path"].previous(targetPath), debug$i(`Adjusting targetPath from ${JSON.stringify(originalPath_0)} to ${JSON.stringify(targetPath)}`);
            }
            ...
            debug$i(`Moving element ${element._key} from path ${JSON.stringify(myPath)} to ${JSON.stringify(targetPath)} (${dragPosition})`), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].moveNodes(editor, {
                at: myPath,
                to: targetPath
            }), editor.onChange();
            return;
            ...
            if (undos.length > 0) {
                ...
                if (debug$h("Undoing", step), step.operations.length > 0) {
                    ...
                    try {
                        ...
                        debug$h("Could not perform undo step", err), remotePatches.splice(0, remotePatches.length), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].deselect(editor), editor.history = {
                            undos: [],
                            redos: []
            ...
            if (redos.length > 0) {
                ...
                if (debug$h("Redoing", step), step.operations.length > 0) {
                    ...
                    try {
                        ...
                        debug$h("Could not perform redo step", err), remotePatches.splice(0, remotePatches.length), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].deselect(editor), editor.history = {
                            undos: [],
                            redos: []
...
async function updateValue({ context, sendBack, slateEditor, streamBlocks, value }) {
    ...
    if ((!value || value.length === 0) && (debug$g("Value is empty"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Editor"].withoutNormalizing(slateEditor, ()=>{
...
function _updateBlock(slateEditor, currentBlock, oldBlock, currentBlockIndex) {
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].setNodes(slateEditor, currentBlock, {
        ...
        currentBlock.children.length < oldBlockChildrenLength && Array.from(Array(oldBlockChildrenLength - currentBlock.children.length)).forEach((_, index)=>{
            ...
            childIndex > 0 && (debug$g("Removing child"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].removeNodes(slateEditor, {
                at: [
                    currentBlockIndex,
                    childIndex
                ]
            ...
            if (isChildChanged) if (currentBlockChild._key === oldBlockChild?._key) {
                debug$g("Updating changed child", currentBlockChild, oldBlockChild), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].setNodes(slateEditor, currentBlockChild, {
                    at: path
                });
                ...
                isSpanNode && isTextChanged ? (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].delete(slateEditor, {
                    ...
                    at: path
                }), slateEditor.onChange()) : isSpanNode || (debug$g("Updating changed inline object child", currentBlockChild), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].setNodes(slateEditor, {
                    _key: VOID_CHILD_KEY
                }, {
                    at: [
                        ...path,
            ...
            } else oldBlockChild ? (debug$g("Replacing child", currentBlockChild), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].removeNodes(slateEditor, {
                at: [
                    currentBlockIndex,
                    currentBlockChildIndex
                ]
            ...
            }), slateEditor.onChange()) : oldBlockChild || (debug$g("Inserting new child", currentBlockChild), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].insertNodes(slateEditor, currentBlockChild, {
                at: [
                    currentBlockIndex,
                    currentBlockChildIndex
                ]
...
function insertPatch(editor, patch, schemaTypes) {
    ...
    if (patch.path.length === 1) {
        ...
        return debug$d(`Inserting blocks at path [${normalizedIdx2}]`), debugState(editor, "before"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].insertNodes(editor, blocksToInsert, {
            at: [
                normalizedIdx2
            ]
...
function unsetPatch(editor, patch) {
    ...
    if (patch.path.length === 1) {
        ...
        return debug$d(`Removing block at path [${blockIndex}]`), debugState(editor, "before"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].removeNodes(editor, {
            at: [
                blockIndex
            ]
        }), debugState(editor, "after"), !0;
        ...
        return editor.apply = (op)=>{
            ...
            if (op.type === "remove_node") {
                ...
                if (op.path[0] === 0 && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Editor"].isVoid(editor, node)) {
                    ...
                    editor.children[nextPath[0]] || (debug$b("Adding placeholder block"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Editor"].insertNode(editor, editor.pteCreateTextBlock({
                        decorators: []
                    })));
                }
            }
        ...
        return editor.normalizeNode = (nodeEntry)=>{
            ...
            if (op.type === "merge_node" && op.path.length === 1 && "markDefs" in op.properties && op.properties._type === types.block.name && Array.isArray(op.properties.markDefs) && op.properties.markDefs.length > 0 && op.path[0] - 1 >= 0) {
                ...
                if (editor.isTextBlock(targetBlock)) {
                    ...
                    debug$9("Copying markDefs over to merged block", op), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].setNodes(editor, {
                        markDefs: newMarkDefs
                    }, {
                        at: targetPath,
                        voids: !1
        ...
        return editor.pteExpandToWord = ()=>{
            ...
            if (selection && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Range"].isExpanded(selection)) {
                ...
                if (!(newStartOffset === newEndOffset || Number.isNaN(newStartOffset) || Number.isNaN(newEndOffset))) {
                    debug$7("pteExpandToWord: Expanding to focused word"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].setSelection(editor, {
                        anchor: {
                            ...selection.anchor,
        ...
        delete: (selection, options)=>{
            if (selection) {
                ...
                if (range) {
                    ...
                    options?.mode === "blocks" && (debug$5("Deleting blocks touched by selection"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Transforms"].removeNodes(editor, {
                        at: range,
                        voids: !0,
...
const addAnnotationActionImplementation = ({ context, action })=>{
    ...
    if (debug$5("Removing annotation", action.annotation.name), !!editor.selection) if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Range"].isCollapsed(editor.selection)) {
        const [block, blockPath] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Editor"].node(editor, editor.selection, {
            depth: 1
        });
    ...
    return emojiPickerActor.start(), emojiPickerActor.subscribe((state)=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$behavior$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defineBehavior"])({
            ...
            guard: ({ context, event })=>{
                ...
                const focusBlock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$selector$2e$is$2d$at$2d$the$2d$start$2d$of$2d$block$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFocusTextBlock"])({
                    context
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$behavior$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defineBehavior"])({
            ...
            guard: ({ context, event })=>{
                ...
                }) : void 0, focusBlock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$selector$2e$is$2d$at$2d$the$2d$start$2d$of$2d$block$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFocusTextBlock"])({
                    context
...
//# sourceMappingURL=node_modules_%40portabletext_editor_lib_0da984._.js.map