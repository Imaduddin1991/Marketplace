...
let k = {};
typeof globalThis < "u" ? k = globalThis : "undefined" < "u" ? k = window : typeof global < "u" ? k = global : typeof self < "u" && (k = self);
var q = k;
function A(e = {}) {
...
class T {
    ...
    constructor(e){
        ...
        this.promise = new Promise((e)=>{
            ...
            this.reason || (this.reason = new $(e), t(this.reason));
        });
    }
    static source = ()=>{
        let e;
...
N.Cancel = $, N.CancelToken = T, N.isCancel = (e)=>!(!e || !e?.__CANCEL__);
var M = (e, t, s)=>("GET" === s.method || "HEAD" === s.method) && (e.isNetworkError || !1);
function _(e) {
...
const H = (B = n, function(e = {}) {
    const { maxRetries: t = 3, ms: s = 1e3, maxFree: n = 256 } = e, { finalizeOptions: r } = B({
        keepAlive: !0,
        keepAliveMsecs: s,
        maxFreeSockets: n
    });
...
class LiveClient {
   ...
   */ events({ includeDrafts = !1, tag: _tag } = {}) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["concat"])(checkCors, events);
    }
}
...
//# sourceMappingURL=node_modules_eb8333._.js.map