...
const ProductGrid: React.FC = () => {
    return (
        <div className="relative py-16">
            ...
            {/* Products Grid */}
            <div className="container lg:w-[1440px] mx-auto px-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    {[ 
                        ...
                        >
                            ...
                            {product.discount && (
                                <div
                                    className={`absolute top-6 right-6 w-[48px] h-[48px] rounded-full text-white text-[16px] flex items-center justify-center 
